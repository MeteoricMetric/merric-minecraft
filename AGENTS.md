# AGENTS.md — merric-minecraft

> Companion file to the master `AGENTS.md` in `merricstrough.com`. This one is scoped to infrastructure operations.

## Project

**MeteoricCraft** Minecraft server. Paper 1.21.11 + Geyser + Floodgate, Docker Compose, playit.gg tunnel, hosted on Shane's home workstation (hardware/OS specifics in `Codex.local.md`).
...
This repo inherits the operating principles from `merricstrough.com/AGENTS.md` Section 1. The infrastructure-specific application:
...
Inherited from `merricstrough.com/AGENTS.md` Section 5, with additions:
...
The change-management ladder (RUNBOOK.md §1) defines what's safe at each tier. This Codex-specific summary aligns with that ladder.
...
- Master AGENTS.md (sets all conventions): https://github.com/MeteoricMetric/meteoricmetric.github.io/blob/main/AGENTS.md
